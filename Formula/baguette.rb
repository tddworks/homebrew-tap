...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.73/baguette_v0.1.73_macOS_arm64.tar.gz"
    sha256 "db24ffb8c5f8bb4e435335f017ab3c0624aed0b00531c52ea8f5875bd50d8a15"
  end
