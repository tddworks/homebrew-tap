...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.4/baguette_v0.1.4_macOS_arm64.tar.gz"
    sha256 "04b96ef8189ad0daf8dd24a912e94184ddbfe8691b6b004d5a18854fee6391f2"
  end
