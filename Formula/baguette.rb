...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.2/baguette_v0.1.2_macOS_arm64.tar.gz"
    sha256 "1802320f525aa4c96aae4141bf6133fc8bdbe11f50afcca8100ef8212a3be924"
  end
