...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.76/baguette_v0.1.76_macOS_arm64.tar.gz"
    sha256 "ccff07fe08a0ce86839325bc3741b53d16286bd8703a2d31525fd9469ab28498"
  end
