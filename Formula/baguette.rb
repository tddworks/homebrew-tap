...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.3/baguette_v0.1.3_macOS_arm64.tar.gz"
    sha256 "07b3f45d06741ec76116a1aae2a81450466131ad1820a6958181c27c7ed1f0f3"
  end
