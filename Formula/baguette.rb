...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.77/baguette_v0.1.77_macOS_arm64.tar.gz"
    sha256 "61e2b42c8635ceffbf3acfb4c86318b3709114492860b266e149d668a619fa14"
  end
