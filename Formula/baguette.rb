...
class Baguette < Formula
  ...
  on_arm do
    url "https://github.com/tddworks/baguette/releases/download/v0.1.74/baguette_v0.1.74_macOS_arm64.tar.gz"
    sha256 "fb76ea22f95ebc571eb7e50065a65ae04ef23ca04ede20eb6a5b1e99fbc783c1"
  end
